...
public class ModuleTypeProcessor extends MetaAnnotationProcessor {

	public void handle() {
		
		//meta to metameta
		Set<String> classSet = AnnotationHelper.getClassList(ModuleType.class);
...
//todo check implementing module interface..	    	
	    	...
	    	ModuleType metaTypeData = moduleClass.getAnnotation(ModuleType.class);
	...
	private class ModuleTypeData {
		...
		public ModuleTypeData(ModuleType moduleType,Class<? extends Module> moduleClass){
